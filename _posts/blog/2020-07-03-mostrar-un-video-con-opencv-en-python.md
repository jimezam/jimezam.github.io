...
Para revisar la versión completa del código, revise su correspondiente [repositorio](https://github.com/jimezam/Examples-of-OpenCV-with-Python/blob/master/2.%20Show%20video/show_video.py).
